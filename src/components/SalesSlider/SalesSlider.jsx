    ...
    <div className='container sliders h-auto my-8'>
      ...
      >
        <SwiperSlide>
          <Link
            to='/'
            className='card-book relative flex w-full flex-col rounded-x bg-slate-800 bg-clip-border text-white shadow-md h-full rounded-2xl'
          >
            <div className='relative mx-4 -mt-6 h-40 overflow-hidden rounded-xl bg-blue-gray-500 bg-clip-border text-white shadow-lg shadow-blue-gray-500/40 bg-gradient-to-r from-white to-white'>
              <img
        ...
        <SwiperSlide>
          ...
          >
            ...
            <div className='p-6'>
              <h5 className=' card-book-title mb-2 block text-xl font-semibold leading-snug tracking-normal text-blue-gray-900 antialiased'>
                اثر مرکب
              </h5>
              <p className=' card-book-desc block text-base font-light leading-relaxed text-inherit antialiased'>
                لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با
