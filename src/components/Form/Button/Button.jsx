...
import './Button.css'
export default function Button ({ text, type, onSubmitForm }) {
  ...
  return (
    <button
      ...
      type={type}
      className='button w-fit relative text-2xl mt-8 mx-auto px-8 py-2 rounded-3xl bg-white isolation-auto z-10 border-2 border-slate-800
